...
Popup {
    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            PendantButton { Layout.fillWidth: true; text: popup.rejectText; accent: "#b65252"; onClicked: { popup.close(); popup.rejected() } }
            PendantButton { Layout.fillWidth: true; text: popup.acceptText; accent: "#468cff"; onClicked: { popup.close(); popup.accepted() } }
        }
    }
}
